  ...
  return (
    <section id="about" className="py-24 px-4 md:px-8 max-w-7xl mx-auto w-full select-none">
      ...
      <div className="mb-16 text-center lg:text-left">
        <span className="font-mono text-xs text-cyan-400 tracking-widest uppercase block mb-2">// DIRECTIVE: CORE_SYSTEM_DIAGNOSTICS</span>
        <h2 className="text-3xl md:text-4xl font-extrabold text-slate-100 tracking-wider">
          PROFESSIONAL STORY LOG
        </h2>
        <div className="w-24 h-[2px] bg-gradient-to-r from-cyan-400 to-transparent mt-3 mx-auto lg:mx-0"></div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch select-text">
        ...
        <div className="lg:col-span-8 flex">
          <div className="p-8 border border-cyan-500/10 glass-panel rounded-lg shadow-hud-glow flex flex-col justify-between relative group">
            ...
            <div className="space-y-6 text-slate-300 text-sm md:text-base leading-relaxed">
              ...
              <p>
                Throughout my professional journey, I have honed my skill set in a specialized, production-ready stack comprising **Node.js, Express.js, TypeScript, MySQL, and MongoDB**. Rather than just writing simple lines of code, I focus heavily on the complete database schema design, system architecture planning, security shielding, and cloud deployment pipelines.
              </p>
